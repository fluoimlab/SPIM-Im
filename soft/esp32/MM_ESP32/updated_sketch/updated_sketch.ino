...
// Set the output channnels, these are the ones for most handy for TinyPico
const int inPin_ = 5;
const int ch1 = 25;
const int ch2 = 26;
const int ch3 = 27;
...
void setup() {
  ...
  // Setting up pwm
  // ledcAttach(pwmCh3, PWMfreq, PWMresolution);
  // ledcAttach(pwmCh4, PWMfreq, PWMresolution);
  // ledcAttach(pwmCh5, PWMfreq, PWMresolution);
  // ledcAttach(pwmCh6, PWMfreq, PWMresolution);
  // ledcAttach(pwmCh7, PWMfreq, PWMresolution);
  // ledcAttach(pwmCh8, PWMfreq, PWMresolution);

  // ledcAttach(ch3, pwmCh3);
  // ledcAttach(ch4, pwmCh4);
  // ledcAttach(ch5, pwmCh5);
  // ledcAttach(ch6, pwmCh6);
  // ledcAttach(ch7, pwmCh7);
  // ledcAttach(ch8, pwmCh8);
